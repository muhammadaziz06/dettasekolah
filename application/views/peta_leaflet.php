...
var map = L.map('map', {
center: [-6.2410732906335395, 107.03472877833293],
zoom: 15,
zoomControl: false,
layers:[]
});
...
$.getJSON("<?= base_url() ?>assets/sekolah1.geojson", function(data) {
    var ratIcon = L.icon({
        iconUrl: '<?= base_url() ?>assets/Marker-5.png',
        iconSize: [52, 50]
    });
    L.geoJson(data, {
        pointToLayer: function(feature, latlng) {
            ...
            marker.bindPopup(
                '<img src = "<?= base_url() ?>assets/images/foto_sekolah/' +
                nama +
